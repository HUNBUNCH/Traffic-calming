...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,0,699,703],[701,0,577,585]]},
		{name:"index_atlas_2", frames: [[0,0,699,703],[0,705,699,703],[701,0,699,703],[701,705,699,703]]},
		{name:"index_atlas_3", frames: [[0,0,699,703],[0,705,699,703],[701,0,699,703],[701,705,699,703]]},
		{name:"index_atlas_4", frames: [[0,0,1732,1032],[0,1034,699,703],[701,1034,699,703]]},
		{name:"index_atlas_5", frames: [[0,0,1748,1858]]}
];
...
(lib.Allmodesvect20101 = function() {
...
if (reversed == null) { reversed = false; }
	...
	this.instance = new lib.ThumbsupTII();
	this.instance.setTransform(-66,16,0.0762,0.0762);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text_1},{t:this.instance},{t:this.text}]}).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-92,-92,0.2632,0.2617);
	...
	this.instance_1 = new lib.image02();
	this.instance_1.setTransform(-92,-92,0.2632,0.2617);

	this.instance_2 = new lib.image03();
	this.instance_2.setTransform(-92,-92,0.2632,0.2617);

	this.instance_3 = new lib.image04();
	this.instance_3.setTransform(-92,-92,0.2632,0.2617);

	this.instance_4 = new lib.image05();
	this.instance_4.setTransform(-92,-92,0.2632,0.2617);

	this.instance_5 = new lib.image06();
	this.instance_5.setTransform(-92,-92,0.2632,0.2617);

	this.instance_6 = new lib.image07();
	this.instance_6.setTransform(-92,-92,0.2632,0.2617);

	this.instance_7 = new lib.image08();
	this.instance_7.setTransform(-92,-92,0.2632,0.2617);

	this.instance_8 = new lib.image09();
	this.instance_8.setTransform(-92,-92,0.2632,0.2617);

	this.instance_9 = new lib.image10();
	this.instance_9.setTransform(-92,-92,0.2632,0.2617);

	this.instance_10 = new lib.image11();
	this.instance_10.setTransform(-92,-92,0.2632,0.2617);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("MEMORY GAME", "normal 700 59px 'Passion One'", "#666666");
	this.text.textAlign = "center";
	this.text.lineHeight = 62;
	this.text.lineWidth = 476;
	this.text.parent = this;
	this.text.setTransform(466.65,113.1);
	if(!lib.properties.webfonts['Passion One']) {
		lib.webFontTxtInst['Passion One'] = lib.webFontTxtInst['Passion One'] || [];
		lib.webFontTxtInst['Passion One'].push(this.text);
	}

	this.text_1 = new cjs.Text("You have 5 seconds to memorise the the pairs\nOne they are flipped over, you need to match the pairs", "normal 400 28px 'Passion One'", "#666666");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 31;
	this.text_1.lineWidth = 841;
	this.text_1.parent = this;
	this.text_1.setTransform(490.7,383.7);
	if(!lib.properties.webfonts['Passion One']) {
		lib.webFontTxtInst['Passion One'] = lib.webFontTxtInst['Passion One'] || [];
		lib.webFontTxtInst['Passion One'].push(this.text_1);
	}

	this.instance = new lib.Allmodesvect20101();
	this.instance.setTransform(326,168,0.2071,0.2071);

	this.text_2 = new cjs.Text("TRAFFIC CALMING", "normal 700 93px 'Passion One'", "#BACF00");
	this.text_2.textAlign = "center";
	this.text_2.lineHeight = 96;
	this.text_2.lineWidth = 703;
	this.text_2.parent = this;
	this.text_2.setTransform(469.5,14.9);
	if(!lib.properties.webfonts['Passion One']) {
		lib.webFontTxtInst['Passion One'] = lib.webFontTxtInst['Passion One'] || [];
		lib.webFontTxtInst['Passion One'].push(this.text_2);
	}
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.playButton},{t:this.text_2},{t:this.instance},{t:this.text_1},{t:this.text}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.MenuScreen, new cjs.Rectangle(68.1,12.9,845.3,500.9), null);
...
p.nominalBounds = new cjs.Rectangle(480,269.5,460.5,256.6);
// library properties:
lib.properties = {
