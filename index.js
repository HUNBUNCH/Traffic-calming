...
lib.ssMetadata = [
		...
		{name:"index_atlas_2", frames: [[1447,0,400,400],[1447,402,400,400],[0,518,400,400],[402,518,400,400],[804,587,400,400],[0,920,400,400],[402,920,400,400],[0,1322,400,400],[402,1322,400,400],[1206,804,400,400],[804,989,400,400],[868,0,577,585],[0,0,866,516]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(263,156,0.5037,0.5037);

	this.text = new cjs.Text("URBAN MOBILITY", "bold 93px 'Century Gothic'", "#FFFFFF");
	this.text.textAlign = "center";
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#BACF00").s().p("EhSUA2QMAAAhsfMCkpAAAMAAABsfg");
	this.shape.setTransform(495.775,207.35);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.playButton},{t:this.text},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.MenuScreen, new cjs.Rectangle(-31.1,-139.9,1053.8,694.5), null);
...
p.nominalBounds = new cjs.Rectangle(448.9,130.1,573.8000000000001,424.5);
// library properties:
lib.properties = {
